...
def build_crystallizer_watertap_cost_param_block(blk):
...
def cost_crystallizer_watertap(blk, cost_type=CrystallizerCostType.default):
    """
...
@register_costing_parameter_block(
    build_rule=build_crystallizer_watertap_cost_param_block,
