...
def create_Permian():
    df1 = fetch_file(file = "diff_sweep_analysisType_Permian_ST1_diff_analysis.h5_29_05-16_16_17_.bak", yaml_file="Permian_ST_1_diff.yaml", case = "RPT1")
    df2 = fetch_file(file = "/Users/zbinger/Downloads/diff_sweep_analysisType_Permian_ST2_diff_analysis 3.h5", yaml_file="Permian_ST_2_diff.yaml", case = "ZLD1")
    df3 = fetch_file(file = "diff_sweep_analysisType_Permian_RPT2_diff_analysis.h5", yaml_file="Permian_RPT_2_diff.yaml", case = "RPT2")
    df4 = fetch_file(file = "diff_sweep_analysisType_Permian_ZLD2_diff_analysis.h5", yaml_file="Permian_ZLD_2_diff.yaml", case = "ZLD2")
    # df = pd.concat([df1, df2, df3])
    df = pd.concat([df1, df2, df3, df4])
    # df = df3
    df = df.sort_values(by=['Group', 'Case', 'Sweep'])
    ...
    plot_voi(df, filename='Permian_VOI_5_2')
