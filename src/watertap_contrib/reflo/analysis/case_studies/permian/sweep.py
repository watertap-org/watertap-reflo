...
import watertap_contrib.reflo.analysis.case_studies.permian.permian_fo_cryst_RPT as ZLD2
...
def run_case_sweep(case, case_name=None, yaml_file=None):
    ...
    map_yaml_file = "/Users/ksitterl/Documents/Python/watertap-reflo/watertap-reflo/src/watertap_contrib/reflo/analysis/case_studies/permian/permian_fo_cryst_RPT_diff.yaml"
    ...
    lT = loopTool(
        ...
        number_of_subprocesses=21,
    )

def run_diff_sweep(case, case_name=None, diff_yaml_file=None):
    # diff_yaml_file = os.path.join(sweep_yaml_dir, diff_yaml_file)
    diff_yaml_file = "/Users/ksitterl/Documents/Python/watertap-reflo/watertap-reflo/src/watertap_contrib/reflo/analysis/case_studies/permian/permian_fo_cryst_RPT_diff.yaml"
...
def run_all_cases():
    cases = [
        {"case": ZLD2, "case_name": "Permian_ST_1", "yaml_file": "Permian_ST_1.yaml"},
...
def run_all_diff_cases():
    cases = [
        ...
        {"case": ZLD2, "case_name": "permian_ZLD2_diff", "yaml_file": "Permian_ST_2_diff.yaml"},
