...
@declare_process_block_class("Translator_Draw_to_SW")
class Translator_Draw_to_SW_Data(TranslatorData):
    """
    Translator block for Draw Solution to Seawater property packages
    """
