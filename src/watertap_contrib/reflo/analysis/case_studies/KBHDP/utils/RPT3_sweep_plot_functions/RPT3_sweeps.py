...
util_dir = os.path.dirname(parent_dir)
sweep_csv_dir = os.path.join(os.path.dirname(util_dir), "sweep_csvs")
...
def run():
    ...
    if only_plot == False:
        ...
        filename = os.path.join(sweep_csv_dir, f"{sweep_type}_grid_frac_{grid_frac}_recovery_{rec}.csv")
        print(df)
        df.to_csv(filename)
    ...
    # filename = (
    #     "/Users/mhardika/Documents/watertap-seto/Mukta-Work/kbhdp-case-study-md/RPT3_sweep_results//"
    #     + sweep_type
    #     + "_grid_frac_"
    #     + grid_frac
    #     + "_recovery_"
