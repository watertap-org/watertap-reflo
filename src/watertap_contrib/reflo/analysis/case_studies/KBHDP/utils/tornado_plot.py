...
if __name__ == "__main__":
    ...
    lcow_low_values = pd.Series({
        "nacl_recovery_price":2.44395346919467,
        'cst_cost_per_total_aperture_area':2.50649676660252,
        'cst_cost_per_storage_capital':2.47817061173503,
        'pv_cost_per_watt_installed':2.6771379020174,
    } 
    )
    lcow_high_values = pd.Series({
        "nacl_recovery_price": 2.74898429669589,
        'cst_cost_per_total_aperture_area':2.8702280617155,
        'cst_cost_per_storage_capital':2.88439113913916,
        'pv_cost_per_watt_installed':2.78456595121143,
    } 
    )
