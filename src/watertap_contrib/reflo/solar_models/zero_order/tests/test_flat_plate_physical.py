...
from watertap_contrib.reflo.solar_models.zero_order.flat_plate_physical.flat_plate_physical import FlatPlatePhysical
...
class TestFlatPlatePhysical:
    ...
    def test_config(self,flat_plate_frame):
        ...
        assert m.fs.flatplate.config.momentum_balance_type is MomentumBalanceType.pressureTotal
    ...
    def test_solution(self, flat_plate_frame):
        ...
        assert pytest.approx(52.94, rel=1e-3) == value(m.fs.flatplate.electricity)  # [W]
