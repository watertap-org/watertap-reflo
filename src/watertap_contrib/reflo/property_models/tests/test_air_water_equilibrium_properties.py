...
def m():
    props = {
        "solute_list": ["TCA"],
        "mw_data": {"TCA": 0.1334},
        "dynamic_viscosity_data": {"Liq": 0.00115, "Vap": 0.0000175},
        "henry_constant_data": {"TCA": 0.487},
        "temp_adjust_henry": False,
        "standard_enthalpy_change_data": {"TCA": 24.28e3},
        "temperature_boiling_data": {"TCA": 360},
