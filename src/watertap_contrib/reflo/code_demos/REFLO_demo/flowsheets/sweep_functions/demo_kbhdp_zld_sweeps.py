...
def sweep_kbhdp_zld_grid_only(sweep_type = "grid_frac_heat", only_plot = True):
    sweep_dict = {
    'ro_water_recovery':[0.6,0.8],
    'nacl_recovery_price':[0,-0.012,-0.024],
    'grid_frac_heat':np.linspace(0.3,0.7,5),
    ...
    xcol_dict = {
        ...
        'grid_frac_heat':'fs.costing.frac_heat_from_re'
    }
    ...
    if only_plot==False:
        ...
        filename = "/Users/mhardika/Documents/watertap-seto/Mukta-Work/Demo/kbhdp_zld_solar_" + sweep_type + ".csv"
        df.to_csv(filename)
...
if __name__ == "__main__":
    sweep_kbhdp_zld_grid_only(sweep_type = "grid_frac_heat", only_plot = True)
