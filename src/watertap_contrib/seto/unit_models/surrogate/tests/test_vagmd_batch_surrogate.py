...
class TestVAGMD:
    ...
    def VAGMD_frame(self):
        ...
        m.fs.vagmd.evaporator_in_props[0].temperature.fix(TEI + 273.15)
        m.fs.vagmd.condenser_in_props[0].temperature.fix(TCI + 273.15)
    ...
    def test_solve(self, VAGMD_frame):
        ...
        for i in range(len(m.fs.vagmd.permeate_flux)):
            print(
                "{:<3} {:<10} {:<10} {:<10} {:<10} {:<10} {:<10} {:<10} {:<10} {:<10} {:<10}".format(
                    round(i),
                    ...
                    round(
                        value(m.fs.vagmd.condenser_out_props[i].temperature - 273.15), 4
                    ),
                    round(
                        value(m.fs.vagmd.evaporator_out_props[i].temperature - 273.15),
                        4,
                    ),
                    ...
                    round(
                        value(
                            m.fs.vagmd.feed_props[i].conc_mass_phase_comp["Liq", "TDS"]
                        ),
                        4,
                    ),
