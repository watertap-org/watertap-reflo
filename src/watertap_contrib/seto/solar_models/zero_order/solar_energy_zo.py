...
class SolarEnergyZOData(ZeroOrderBaseData):
    ...
    CONFIG.declare("solar_energy_type", 
            ConfigValue(default="PV", 
    ...
    def pysam_pv(self):
        ...
        def size_pv_array(tech_model, desired_size, desired_dcac_ratio):
            ...
            m['spe_imp'] = spe_power(m['spe_eff4'], m['spe_rad4'], m['spe_area']) / m['spe_vmp']    # 4 = reference conditions
            ...
            if desired_dcac_ratio > 0:
                inverters = ((num_series * num_parallel * mod_power)) / (desired_dcac_ratio * inv_power)
                ...
                num_inverters = np.ceil(((num_series * num_parallel * mod_power)) / inv_power)
        ...
        def get_pv_energy_gen(desired_size, model_name=None, dcac_ratio=1.2):
            ...
            config_files =      ['pysam/untitled_pvsamv1.json',
