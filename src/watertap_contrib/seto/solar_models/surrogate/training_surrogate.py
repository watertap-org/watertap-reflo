...
def create_rbf_surrogate(training_dataframe, input_labels, output_labels, output_filename=None):
    # Capture long output
    stream = StringIO()
...
if __name__ == '__main__':
    ...
    data_training, data_validation = get_training_validation(dataset_filename, n_samples, training_fraction)
